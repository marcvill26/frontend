...
export default function CardcomicList({ ...rest }) {
  const { hero, nameHero, writer, year, image, description } = rest;
  return (
    <div className="comic-card">
      <div className="comic-card__info">
        <div className="comic-card__hero">
          <span>hero:</span> {hero}
        </div>
        <div className="comic-card__name">
          <span>name:</span> {nameHero}
        </div>
        <div className="comic-card__divider"></div>
        <p className="comic-card__bio">
          <span>desciption:</span> {description}
        </p>
